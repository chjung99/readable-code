...
public class MinesweeperGame {
    ...
    private static void actOnCell(String cellInput, String userActionInput) {
        ...
        int selectedColIndex = getSelectedColInex(cellInput);
    ...
    private static boolean isLandMineCell(int selectedRowIndex, int selectedColInex) {
        return LAND_MINES[selectedRowIndex][selectedColInex];
    }
    ...
    private static int getSelectedColInex(String cellInput) {
